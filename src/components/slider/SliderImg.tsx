      ...
      >
        {pictures.map((item) => (
          <div key={item.id} className="slider-item relative group">
            ...
            />
            <div className="absolute bottom-5 left-5 bg-black bg-opacity-50 text-white py-2 px-4 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
